  ...
  const faqs = [
    {
      ...
      answer:
        "No, this platform is designed for educational purposes only and should not be used for actual medical diagnosis. Always consult with qualified healthcare professionals for medical concerns.",
    },
    {
      question: "How accurate are the predictions?",
      answer:
        "Our AI models are trained on educational datasets and provide learning experiences. Accuracy varies depending on the specific use case and should be interpreted within an educational context.",
    },
    // {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Have questions about our educational AI platform? We'd love to hear
            from you.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600 mb-6">
                Whether you have questions about our AI models, want to provide
                feedback, or are interested in educational collaborations, we're
                here to help.
              </p>
